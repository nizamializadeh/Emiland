import 'package:emiland/presentation/screens/jacket/components/note.dart';
          ...
          children: [
                ...
                Stack(
                  children: [
                    SingleSuit(
                        ...
                        onclick: () {
                          var tabIndex = Provider.of<SuitDataProvider>(context,
                                  listen: false)
                              .tabbarIndex;
                          if (tabIndex == 1) {
                ...
                Stack(
                  children: [
                    ...
                    suitInstanceTrue.map2['Qol dibi qaldır/aşağı sal'] < 0
                        ...
                        : const SizedBox.shrink(),
                    suitInstanceTrue.map2['Qolun aşağı hissəsi artır/azalt'] < 0
                        ? SingleSuit(
                            width: 120,
                            height: 350,
                            active: suitInstance.item4,
            ...
            Center(
              child: OutlinedButton(
                child: Padding(
                  padding:
                      EdgeInsets.symmetric(vertical: 24.h, horizontal: 100.w),
                  child: Text(
                    "Qeyd",
                    style:
                        TextStyle(fontWeight: FontWeight.w500, fontSize: 33.sp),
                  ),
                ),
